 ...
 * From a data class, Kotlin generates componentN() task02.functions corresponding to all the properties declared
 * in the primary constructor of the data class. For the Wine data class, Kotlin generates four componentN()
 * task02.functions - component1(), component2(), component3() and component4() corresponding to the id and name properties.
