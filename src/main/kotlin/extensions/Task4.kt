...
/** Infix functions
 * Extension functions can also be prefixed with the infix keyword. This means that functions can be called without
 * the dot and parentheses! Infix methods has to have one, and only one, parameter, which must not be vararg or have
 * a default value.
 *
